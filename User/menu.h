...
#define SENSOR_F_TYPE_ID        ( SENSOR_TYPE_ID        + 1 )    //16
#define T_SENSOR_MIN_ID         ( SENSOR_F_TYPE_ID      + 1 )    //17
#define T_SENSOR_MAX_ID         ( T_SENSOR_MIN_ID       + 1 )    //18
#define CO2_SENSOR_MIN_ID       ( T_SENSOR_MAX_ID       + 1 )    //19
#define CO2_SENSOR_MAX_ID       ( CO2_SENSOR_MIN_ID     + 1 )    //20
#define H_SENSOR_MIN_ID         ( CO2_SENSOR_MAX_ID     + 1 )    //21
#define H_SENSOR_MAX_ID         ( H_SENSOR_MIN_ID       + 1 )    //22
#define T_SENSOR_OFFSET_ID      ( H_SENSOR_MAX_ID       + 1 )    //23
#define CO2_SENSOR_OFFSET_ID    ( T_SENSOR_OFFSET_ID    + 1 )    //24
#define H_SENSOR_OFFSET_ID      ( CO2_SENSOR_OFFSET_ID  + 1 )    //25
#define T_SENSOR_SETTING_ID     ( H_SENSOR_OFFSET_ID    + 1 )    //26
#define CO2_SENSOR_SETTING_ID   ( T_SENSOR_SETTING_ID   + 1 )    //27
#define H_SENSOR_SETTING_ID     ( CO2_SENSOR_SETTING_ID + 1 )    //28
#define AFTER_ZONE_SETTING_ID   ( H_SENSOR_SETTING_ID   + 1 )    //29
#define CDV_CH_COUNT_ID         ( AFTER_ZONE_SETTING_ID + 1 )    //30
#define MEASERING_UNIT_ID       ( CDV_CH_COUNT_ID       + 1 )    //31
#define CLEAN_TIMER_ID          ( MEASERING_UNIT_ID     + 1 )    //32
#define ZERO_POINT_TIMEOUT_ID   ( CLEAN_TIMER_ID        + 1 )    //33
#define PRIOR_SENSOR_ID         ( ZERO_POINT_TIMEOUT_ID + 1 )    //34
#define KK_SENSOR_TYPE_ID       ( PRIOR_SENSOR_ID       + 1 )    //35
#define CO2_SENSOR_TYPE_ID      ( KK_SENSOR_TYPE_ID     + 1 )    //36
#define H_SENSOR_TYPE_ID        ( CO2_SENSOR_TYPE_ID    + 1 )    //37
#define OFFSET2_ID              ( H_SENSOR_TYPE_ID      + 1 )    //38
#define COOF_P_1_ID             ( OFFSET2_ID            + 1 )    //39
#define COOF_I_1_ID             ( COOF_P_1_ID           + 1 )    //40
#define COOF_P_2_ID             ( COOF_I_1_ID           + 1 )    //41
#define COOF_I_2_ID             ( COOF_P_2_ID           + 1 )    //42
#define COOF_P_3_ID             ( COOF_I_2_ID           + 1 )    //43
#define COOF_I_3_ID             ( COOF_P_3_ID           + 1 )    //44
#define BP_SETTING1_ID          ( COOF_I_3_ID           + 1 )    //45
#define BP_FACT_ID              ( BP_SETTING1_ID        + 1 )    //46
#define BP_SIZE_ID              ( BP_FACT_ID            + 1 )    //47
#define BP_REGULATION_TYPE_ID  ( BP_SIZE_ID            + 1 )    //48
#define CH1_ERROR_ID            ( BP_REGULATION_TYPE_ID + 1 )    //50
#define CH2_ERROR_ID            ( CH1_ERROR_ID          + 1 )    //51
#define SETTING_BP_MIN_ID       ( CH2_ERROR_ID          + 1 )    //52
#define SETTING_BP_AVER_ID      ( SETTING_BP_MIN_ID     + 1 )    //53
#define SETTING_BP_MAX_ID       ( SETTING_BP_AVER_ID    + 1 )    //54
#define ZERO_CAL_COMMAND        ( SETTING_BP_MAX_ID      + 1 )
